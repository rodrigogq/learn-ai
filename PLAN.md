...
- [x] 12-data-pipelines — Dataset/DataLoader, augmentation, splits, metrics. C: binary dataset reader.
...
- [x] 19-speech-recognition — the alignment problem; CTC trained end-to-end on synthetic spoken words. C: greedy CTC decoder.
...
- [x] 29-text-to-image-and-video — conditional diffusion (generate a requested digit), classifier-free guidance, toy video. C: guidance scale + frame consistency.
